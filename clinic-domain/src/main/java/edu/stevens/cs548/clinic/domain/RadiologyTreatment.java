...
public class RadiologyTreatment extends Treatment {
	...
	public <T> T export(ITreatmentExporter<T> visitor) {
		// TODO
		return visitor.exportRadiology(treatmentId, patient.getPatientId(), patient.getName(), provider.getProviderId(),
				provider.getName(), diagnosis, DateUtils.fromDatabaseDates(treatmentDates),
