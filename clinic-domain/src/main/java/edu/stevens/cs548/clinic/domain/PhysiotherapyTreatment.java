...
public class PhysiotherapyTreatment extends Treatment {
	...
	public <T> T export(ITreatmentExporter<T> visitor) {
            // TODO
		return visitor.exportPhysiotherapy(treatmentId, patient.getPatientId(), patient.getName(),
				provider.getProviderId(), provider.getName(), diagnosis, DateUtils.fromDatabaseDates(treatmentDates),
