...
public class SurgeryTreatment extends Treatment {
	...
	public <T> T export(ITreatmentExporter<T> visitor) {
		// TODO
		return visitor.exportSurgery(treatmentId, patient.getPatientId(), patient.getName(), provider.getProviderId(),
				provider.getName(), diagnosis, DateUtils.fromDatabaseDate(surgeryDate), dischargeInstructions,
